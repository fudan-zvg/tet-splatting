...
from threestudio.models.geometry.implicit_sdf_tetsplatting import ImplicitSDFTeTSplatting
    ...
    def create_from(
        ...
        **kwargs,
        ...
        if isinstance(other, TetrahedraSDFGrid):
            ...
            instance.isosurface_bbox = mesh.extras["bbox"] * instance.cfg.nerf_scale
            instance.sdf.data = (
            ...
            return instance
        elif isinstance(other, ImplicitSDF) or isinstance(other, ImplicitSDFTeTSplatting):
            instance = TetrahedraSDFGrid(cfg, **kwargs)
            if other.cfg.isosurface_method != "mt":
                other.cfg.isosurface_method = "mt"
                threestudio.warn(
